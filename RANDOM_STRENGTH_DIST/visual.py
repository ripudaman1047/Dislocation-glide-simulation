...
def plot(dis, disLine, tau):
    ...
    array1 = np.array([[obs.x, obs.y, obs.brAngle] for obs in obstacle.array])
    plt.scatter(array1[:,0], array1[:,1], s=size, c=col, edgecolor='black', linewidths=1)
    ...
    plt.scatter(array2[:,0], array2[:,1], s=size, c=col, edgecolor=discolor, linewidths=1)
